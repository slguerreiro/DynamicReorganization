  ...
  ////////////////////////////////////////////////////
   public boolean Start() throws Exception
   {
     try
     {
        ...
        {
          System.out.println("Initial Environment do Process Module:\n" + m_ProcessModule.m_PluginProcess.Actual_Environment().toString());
          WriteFile.Writeln("Initial Environment do Process Module:\n" + m_ProcessModule.m_PluginProcess.Actual_Environment().toString(),Constants.pathOutputFile,Constants.OutputFile);
